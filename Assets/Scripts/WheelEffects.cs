...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class WheelEffects : MonoBehaviour
    {
        ...
        {
            skidding = true;
            m_SkidTrail = PhotonNetwork.Instantiate(SkidTrailPrefab.name, new Vector3(SkidTrailPrefab.transform.position.x, SkidTrailPrefab.transform.position.y,SkidTrailPrefab.transform.position.z),Quaternion.identity,0).transform;
